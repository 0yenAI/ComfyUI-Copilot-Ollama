...
export function ApiKeyModal({ isOpen, onClose, onSave, initialApiKey = '' }: ApiKeyModalProps) {
    ...
    const [llmProvider, setLlmProvider] = useState('openai'); // 'openai' or 'ollama'
    ...
    useEffect(() => {
        ...
        // Load Ollama configuration from localStorage
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-8 w-[480px] shadow-2xl">
                ...
                <div className="mb-6 border-t border-gray-200 dark:border-gray-700 pt-6">
                    <h3 className="text-sm text-gray-900 dark:text-white font-medium mb-4">LLM Provider (Optional)</h3>
